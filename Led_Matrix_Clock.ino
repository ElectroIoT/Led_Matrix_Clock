...
#include "RTClib.h"        // https://www.arduinolibraries.info/libraries/rt-clib              
#include "Button.h"       //https://www.arduinolibraries.info/libraries/button              
...
void printver() {
  ...
  byte i = 0;
  char ver_a[9] = "Vers 1.6";
  char ver_b[9] = "ElectroIoT";
